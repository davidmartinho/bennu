...
/**
 * Builder for all kinds of Spreadsheets (currently supports excel, csv,
 * tsv, and docx). Basically, given a format, and a set of {@link SheetData}s it
...
public class SpreadsheetBuilder {
    ...
    private final Map<Class<?>, ICellStyle> typeStyles = new HashMap<>();
    private List<ICellStyle> rowStyles = new ArrayList<>();
